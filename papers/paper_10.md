...
# Bibliometric Meta-Analysis of Functional Food and Bioactive Compound Research Trends: PubMed Corpus Mining with Structured Time-Series Inference
...
Paper-specific emphasis: I synthesize PubMed trend slopes as bibliometric meta-evidence of research momentum in functional foods, pairing counts with qualitative caveats about indexing bias.
...
`results/`; figures under `figures/paper_10_*.png` so that results can be traced from code to tables to figures.
...
![Figure 1 — PCA variance explained](figures/paper_10_pca_variance.png)

*Figure 1. Principal component variance decomposition for standardized nutrient features.*

![Figure 2 — Nutrient scatter landscape](figures/paper_10_nutrient_scatter.png)

*Figure 2. Bivariate nutrient density landscape with outcome-encoded color.*

![Figure 3 — Feature importance](figures/paper_10_feature_importance.png)

*Figure 3. Ensemble importance estimates for predicting systolic blood pressure.*

![Figure 4 — Cluster sizes](figures/paper_10_clusters.png)

*Figure 4. K-means partition sizes (k=4) on standardized intake variables.*

![Figure 5 — Bibliometric or temporal trend](figures/paper_10_trend.png)
