...
# Convex Surrogate Modeling for AI-Driven Dietary Personalization: Energy–Macronutrient Response Surfaces Calibrated with National Survey and Composition Data
...
Paper-specific emphasis: I articulate convex surrogate modeling for macronutrient response surfaces, linking composition databases with survey-scale outcomes to probe feasibility of data-driven dietary personalization.
...
`results/`; figures under `figures/paper_2_*.png` so that results can be traced from code to tables to figures.
...
![Figure 1 — PCA variance explained](figures/paper_2_pca_variance.png)

*Figure 1. Principal component variance decomposition for standardized nutrient features.*

![Figure 2 — Nutrient scatter landscape](figures/paper_2_nutrient_scatter.png)

*Figure 2. Bivariate nutrient density landscape with outcome-encoded color.*

![Figure 3 — Feature importance](figures/paper_2_feature_importance.png)

*Figure 3. Ensemble importance estimates for predicting systolic blood pressure.*

![Figure 4 — Cluster sizes](figures/paper_2_clusters.png)

*Figure 4. K-means partition sizes (k=4) on standardized intake variables.*

![Figure 5 — Bibliometric or temporal trend](figures/paper_2_trend.png)
