...
# Global Nutrition Inequality and Socioeconomic Gradients in Diet Adequacy: A WHO Global Health Observatory Harmonization Study
...
Paper-specific emphasis: I situate WHO Global Health Observatory harmonization alongside survey microdata to discuss cross-scale inequality metrics and ecological fallacies explicitly.
...
`results/`; figures under `figures/paper_4_*.png` so that results can be traced from code to tables to figures.
...
![Figure 1 — PCA variance explained](figures/paper_4_pca_variance.png)

*Figure 1. Principal component variance decomposition for standardized nutrient features.*

![Figure 2 — Nutrient scatter landscape](figures/paper_4_nutrient_scatter.png)

*Figure 2. Bivariate nutrient density landscape with outcome-encoded color.*

![Figure 3 — Feature importance](figures/paper_4_feature_importance.png)

*Figure 3. Ensemble importance estimates for predicting systolic blood pressure.*

![Figure 4 — Cluster sizes](figures/paper_4_clusters.png)

*Figure 4. K-means partition sizes (k=4) on standardized intake variables.*

![Figure 5 — Bibliometric or temporal trend](figures/paper_4_trend.png)
