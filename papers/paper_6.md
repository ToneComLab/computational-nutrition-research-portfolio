...
# Nutrient Co-Ingestion Topology and Interaction Networks: From Pairwise Correlations to Community Structure in Population Diets
...
Paper-specific emphasis: I interpret co-nutrient networks as hypothesis generators for interaction trials, stressing partial correlation gaps and unmeasured food-pattern confounding.
...
`results/`; figures under `figures/paper_6_*.png` so that results can be traced from code to tables to figures.
...
![Figure 1 — PCA variance explained](figures/paper_6_pca_variance.png)

*Figure 1. Principal component variance decomposition for standardized nutrient features.*

![Figure 2 — Nutrient scatter landscape](figures/paper_6_nutrient_scatter.png)

*Figure 2. Bivariate nutrient density landscape with outcome-encoded color.*

![Figure 3 — Feature importance](figures/paper_6_feature_importance.png)

*Figure 3. Ensemble importance estimates for predicting systolic blood pressure.*

![Figure 4 — Cluster sizes](figures/paper_6_clusters.png)

*Figure 4. K-means partition sizes (k=4) on standardized intake variables.*

![Figure 5 — Bibliometric or temporal trend](figures/paper_6_trend.png)
