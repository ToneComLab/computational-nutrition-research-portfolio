...
# Principal Nutrition Manifolds: PCA-Based Dimensionality Reduction of 24-Hour Nutrient Intakes with Interpretable Loading Structures
...
Paper-specific emphasis: I unpack PCA loading structures as interpretable nutrition manifolds, relating component axes to culturally patterned dietary trade-offs.
...
`results/`; figures under `figures/paper_8_*.png` so that results can be traced from code to tables to figures.
...
![Figure 1 — PCA variance explained](figures/paper_8_pca_variance.png)

*Figure 1. Principal component variance decomposition for standardized nutrient features.*

![Figure 2 — Nutrient scatter landscape](figures/paper_8_nutrient_scatter.png)

*Figure 2. Bivariate nutrient density landscape with outcome-encoded color.*

![Figure 3 — Feature importance](figures/paper_8_feature_importance.png)

*Figure 3. Ensemble importance estimates for predicting systolic blood pressure.*

![Figure 4 — Cluster sizes](figures/paper_8_clusters.png)

*Figure 4. K-means partition sizes (k=4) on standardized intake variables.*

![Figure 5 — Bibliometric or temporal trend](figures/paper_8_trend.png)
